...
【保存方式】
- 豆干絲（宅配）：一律冷凍出貨；真空包裝冷凍保存 10 天；要吃的前一天移至冷藏退冰即可食用
- 豆干絲（門市自取）：門市販售皆為冷藏狀態；一般包裝建議冷凍保存 7 天、冷藏 3 天；若客人有冷凍需求可在訂單備註，門市會另行處理
- 豆干絲（門市自取真空包）：冷凍保存 10 天；要吃的前一天移至冷藏退冰即可食用
...
16. 【付款確認回覆】客人說已匯款，並提供末四碼或末五碼作為憑證（如直接傳「7489」、「末四碼 7489」、「末五碼 05815」、「已匯款」、「匯好了」，或附帶轉出銀行資訊如「052渣打銀行，帳號末五碼05815」）：
