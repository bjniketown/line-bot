...
3. 天然昆布：180 克/包，100 元（真空包裝）
4. 油潑辣子：250ml/罐，120 元（全手工製作，無添加防腐劑）
- 每包豆干絲附有蒜汁 + 辣油調料包

【運費規則】
- 1–38 包：運費 225 元
- 39–49 包：運費 290 元（建議直接湊 50 包，更划算）
- 50 包以上：免運費
- 每箱上限 50 包；超過 50 包須開第二箱，運費依箱計算
...
Q: 50 包免運，不同產品可以混算嗎？
A: 可以！所有品項都可以合計計算，達 50 單位即免運費。

Q: 39 包跟 50 包哪個比較划算？
A: 39 包需加 290 元運費，總金額約 3020 元；50 包免運費，總金額 3500 元，每包均價更低，建議直接湊 50 包。

Q: 1 罐油潑辣子算 1 單位嗎？
A: 是的，1 罐算 1 單位，可與其他品項合計。

Q: 訂超過 50 包怎麼計算？
A: 每箱上限 50 包，超過需開第二箱，各箱運費依規則計算。例如 100 包 = 2 箱，各箱 50 包，皆免運費。
...
Q: 可以去門市自取嗎？
A: 可以！門市購買為一般包裝 60 元/包（非真空）。歡迎親自來訪。

Q: 門市買跟宅配有什麼差別？
A: 門市一般包裝 60 元，宅配真空包裝 70 元，真空包裝保鮮品質更穩定，適合宅配或送禮。
